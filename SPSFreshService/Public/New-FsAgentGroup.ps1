Function New-FsAgentGroup {
<#
.SYNOPSIS
    Creates an agent group within FreshService
.DESCRIPTION
    The New-FsAgentGroup function inputs a new agent group into the FreshService domain
    *REQUIRED PARAMS* - Name
.EXAMPLE
    New-FsAgentGroup -Name 'IT Supers' -Description 'test description' . . .
.PARAMETER
.INPUTS
.OUTPUTS
.NOTES
...
#>
    ...
    Process{
        ...
        Get-FreshServiceAPIResult -APIEndpoint "$($APIURL)/groups" -Body $Body -Method 'POST'
    }
    End{
